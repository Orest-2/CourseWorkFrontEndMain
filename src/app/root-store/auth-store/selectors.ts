...
export const selectSigninIsLoading: MemoizedSelector<object, boolean> = createSelector(
  selectAuthState,
  getIsLoading
);
...
export const selectValidateTokenIsTokenValid: MemoizedSelector<object, boolean> = createSelector(
  selectAuthState,
  getIsTokenValid
);
